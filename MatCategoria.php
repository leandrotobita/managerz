...
if ( isset( $login_cookie ) ) {
	...
	$BuscaCategoriaSQL = "SELECT CatID, CatNome, SoliCatAtivado from gz_material_categoria ";
...
// Altero os dados quando clico em salvar
	...
	if(isset($_POST["alterardados"])){
		 ...
		 $AlteraCadastroSQL = "
		 UPDATE gz_material_categoria SET
...
<script>window.location="MatCategoria.php";</script><?php
...
// Altero os dados quando clico em salvar
	...
	if(isset($_POST["adicionardados"])){
		 ...
		 $AlteraCadastroSQL = "
		 INSERT INTO gz_material_categoria  
...
?>
	...
	<head>
		...
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
		<title>Manager Z - Categorias de Material</title>
...
<div class="modal fade" id="modalsucesso" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action="MatCategoria.php" method="post" enctype="multipart/form-data" name="form" id="form" title="form">
