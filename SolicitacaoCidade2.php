...
LEFT JOIN gz_empresas on gz_empresas.GZ_EMPRESA_ID = gz_solicitacoes.SoliEmpresa  WHERE CIDADE = '".$_GET['city']."' AND status != '3' order by SoliId DESC
	";
                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div> Dashboard (<?php echo $_GET['city']?>)
