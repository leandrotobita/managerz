...
if ( isset( $login_cookie ) ) {
	...
	$BuscaCategoriaSQL = "SELECT SoliCatId, SoliCatDescricao, SoliCatAtivado FROM solicategoria ORDER BY SoliCatDescricao ASC ";
...
// Altero os dados quando clico em salvar
	...
	if(isset($_POST["alterardados"])){
		 ...
		 $AlteraCadastroSQL = "
		 UPDATE solicategoria SET
		 
		 SoliCatDescricao 	= '".$_POST['DESCRICAO']."', 
		 SoliCatAtivado    = '".$_POST['STATUS']."'
		 WHERE   SoliCatId = '".$_POST['SoliCatId']."'";
...
<script>window.location="SoliCategorias.php";</script><?php
...
?>
	...
	<head>
		...
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
		<title>Manager Z - Categorias</title>
						...
						<div class="app-page-title">
							<div class="page-title-wrapper">
								<div class="page-title-heading">
									...
									<div>Controle de Manutenção - Categorias
										<div class="page-title-subheading">Listas de Categorias.</div>
									</div>
								</div>
							</div>
						</div>
...
<div class="modal fade" id="modalsucesso" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action="SoliCategorias.php" method="post" enctype="multipart/form-data" name="form" id="form" title="form">
	...
	<div class="modal fade" id="editModal<?php echo $BuscaCategoriaROW_SoliCatId[$index];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">
						 <i class="lnr-list icon-gradient bg-mean-fruit"></i> Editar categoria
					</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
						...
						<div class="form-row">
							<div class="col-md-12">
								<div class="position-relative form-group">
									...
									<input name="CATEGORIA" id="CATEGORIA" PlaceHolder="Ex: Hidráulica" type="text" class="form-control">
								</div>
							</div>
